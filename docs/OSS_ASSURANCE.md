...
This document is a repository self-assessment for supply-chain and open-source hygiene controls. It records implementation status and verification evidence for this project.
...
| SPDX SBOM | implemented | `.github/workflows/sbom.yml`, `.github/workflows/release.yml`, `docs/ARTIFACTS.md`; release assets include `sbom.spdx.json` |
| CycloneDX SBOM | implemented | `.github/workflows/sbom.yml`, `.github/workflows/release.yml`, `docs/ARTIFACTS.md`; release assets include `sbom.cdx.json` |
| SLSA / GitHub artifact attestations | implemented | `.github/workflows/release.yml`; release artifacts are attested by GitHub artifact attestations and can be verified with `gh attestation verify` |
| Sigstore / cosign | implemented | `.github/workflows/release.yml`; release assets include `.sigstore.json` cosign bundles |
...
| CODEOWNERS | implemented | `.github/CODEOWNERS` documents ownership for sensitive paths; required CODEOWNERS approval is intentionally not enforced in solo-maintainer mode |
